...
- ⚙️ バックエンド: http://localhost:8080
- 🤖 LiteLLM: http://localhost:4000
- 🔍 Qdrant: http://localhost:6333

**詳細は [DOCKER.md](DOCKER.md) をご覧ください。**

### 💻 開発環境（ローカル実行）

インフラのみDockerで起動し、コードはローカルで実行：
